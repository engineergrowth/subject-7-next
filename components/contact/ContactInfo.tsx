          ...
          {contactInfo.map((info, index) => (
            ...
            >
              <motion.div 
                ...
                viewport={{ once: true }}
                className={`w-16 h-16 mx-auto mb-4 rounded-xl ${info.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-lg`}
              >
