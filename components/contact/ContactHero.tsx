    ...
    <section className="relative bg-gray-950 text-white py-32 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <motion.h2 
          ...
          className="text-3xl sm:text-4xl md:text-5xl font-bold text-purple-700 leading-[1.1] tracking-tight mb-8"
        >
        ...
        >
          ...
          <Link
            ...
            className="text-purple-700 underline underline-offset-4 hover:text-purple-600 transition-colors duration-300"
          >
            click here
          </Link>.
        </motion.p>
